...
pub fn get_month_names(month: u32) -> Vec<&'static str> {
    match month {
        1 => vec![
            "January", "Janvier", "Enero", "Januar", "Gennaio", "Janeiro", "一月", "1月", "睦月",
            "Jan",
        ],
        2 => vec![
            "February",
        ...
        3 => vec![
            "March", "Mars", "Marzo", "März", "Marzo", "Março", "三月", "3月", "弥生", "Mar",
        ],
        4 => vec![
            "April", "Avril", "Abril", "April", "Aprile", "Abril", "四月", "4月", "卯月", "Apr",
        ],
        5 => vec![
            "May", "Mai", "Mayo", "Mai", "Maggio", "Maio", "五月", "5月", "皐月", "May",
        ],
        6 => vec![
            "June",
            "Juin",
        ...
        7 => vec![
            "July", "Juillet", "Julio", "Juli", "Luglio", "Julho", "七月", "7月", "文月", "Jul",
        ],
        8 => vec![
            "August", "Août", "Agosto", "August", "Agosto", "Agosto", "八月", "8月", "葉月", "Aug",
        ],
        9 => vec![
            "September",
            "Septembre",
